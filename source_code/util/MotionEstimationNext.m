function [motionMap, uv] = MotionEstimationNext(imgCur, imgNext, blockSize, maxSearchRadius, lambda_reg, bVisualize)
%
%       [motionMap, uv] = MotionEstimationNext(imgCur, imgNext, blockSize, maxSearchRadius, lambda_reg, bVisualize)
%
%       This function computes motion estimation between consecutive frames
%
%       input:
