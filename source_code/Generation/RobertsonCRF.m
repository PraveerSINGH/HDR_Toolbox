function lin_fun = RobertsonCRF(stack, stack_exposure, max_iterations, err_threshold, bPolyFit)
%
%       lin_fun = RobertsonCRF(stack, stack_exposure, max_iterations, err_threshold, bPolyFit)
%
